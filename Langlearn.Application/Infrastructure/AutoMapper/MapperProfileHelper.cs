...
namespace Langlearn.Application.Infrastructure.AutoMapper
{
	...
	{
		public static IList<Map> LoadStandardMappings(Assembly rootAssembley)
		{
			var types = rootAssembley.GetExportedTypes();
